...
dns-resolver:
  config:
    ...
    - 2001:db8:1::ffbb
....
<1> `interfaces.name`: The name of the network interface to configure
<2> `interfaces.type`: The type of network device
<3> `interfaces.state`: The desired state of the interface after configuration
